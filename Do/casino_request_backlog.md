...
| P1 | Add visible rules and payout tables where missing | UX | In progress | Blackjack needed this most; other major games already expose help or payout screens. |
