...
- Use `scripts/sync-roger-code.ps1 -Game <Name>` when you want the manifest refreshed and a game deployed to the PrismLauncher world in one pass.
- `scripts/deploy-to-world.ps1` is the direct deploy entry point for live ComputerCraft saves.
